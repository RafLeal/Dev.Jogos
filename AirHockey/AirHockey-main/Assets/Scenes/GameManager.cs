...
public class GameManager : MonoBehaviour
{
    ...
    void OnGUI () {
        GUI.skin = layout;
        GUI.Label(new Rect(Screen.width / 3 - 110 - 12, 0, 120, 100), "" + PlayerScore1);
        GUI.Label(new Rect(Screen.width / 3 - 145 + 12, 450, 120, 100), "" + PlayerScore2);

        if (GUI.Button(new Rect(Screen.width / 2 - 355, 225, 120, 53), "RESTART"))
        {
            PlayerScore1 = 0;
            PlayerScore2 = 0;
